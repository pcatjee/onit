...
import ManageMoney from "../TabsScreen/ManageMoney";
import PersonalExpense from "../TabsScreen/PersonalExpense";
...
const TabNavigator = createMaterialTopTabNavigator(
  {
    ...
    PersonalExpense: {
      screen: PersonalExpense,
      navigationOptions: {
        tabBarLabel: "Personal Expense",
        showLabel: ({ focused }) => {
          console.log(focused);
          return focused ? true : false;
        },
